...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        private void OpenWiki_Click(object sender, EventArgs e)
        {
            ...
            Process.Start("https://github.com/shadowsocksr-backup/shadowsocks-rss/wiki");
        }

        private void FeedbackItem_Click(object sender, EventArgs e)
        {
            Process.Start("https://github.com/shadowsocksr-backup/shadowsocksr-csharp/issues/new");
            // Process.Start("https://github.com/shadowsocks/shadowsocksr-csharp/issues/new");
        }
        ...
        {
            string abrstr =
                I18N.GetString("Shadowsocks is a Socks5-based proxy package to encrypt and protect data streaming on the Internet.") + "\n" +
                I18N.GetString("Original Shadowsocks project (2012-2015) by clowwindy.") + "\n" +
                I18N.GetString("ShadowsocksR project fork by breakwa11.");
            ...
            if (name.StartsWith("zh"))
            {
                if (name == "zh-TW")
                {
                    abrstr += ("\n臺灣正體中文由 kingwilly71 修正。");
                }
            }

            MessageBox.Show(abrstr, I18N.GetString("About ShadowsocksR "+ UpdateChecker.Version),
